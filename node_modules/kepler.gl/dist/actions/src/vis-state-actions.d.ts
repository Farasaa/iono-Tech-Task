...
import { AddDataToMapPayload, ValueOf, Merge, RGBColor, NestedPartial, LayerVisConfig, ColorUI, Feature, FeatureSelectionContext, InteractionConfig, Filter, ParsedConfig, ParsedLayer, EffectPropsPartial } from '@kepler.gl/types';
 ...
 * @public
 */
export declare function layerVisualChannelConfigChange(oldLayer: Layer, newConfig: Partial<LayerBaseConfig>, channel: string): Merge<LayerVisualChannelConfigChangeUpdaterAction, {
 ...
 * @public
 */
export declare function setFilter(idx: number, prop: string, value: any, valueIndex?: number): Merge<SetFilterUpdaterAction, {
 ...
 * @public
 */
export declare function setColumnDisplayFormat(dataId: string, formats: {
    [key: string]: string;
}): Merge<SetColumnDisplayFormatUpdaterAction, {
...
export declare type ToggleLayerAnimationUpdaterAction = {};
/**
...
export declare type ToggleLayerAnimationControlUpdaterAction = {};
/**
 ...
 * @public
 */
export declare function onLayerHover(info: (PickInfo<any> & {
    mapIndex?: number;
}) | null): Merge<OnLayerHoverUpdaterAction, {
...
export declare type OnMapClickUpdaterAction = {};
/**
 ...
 * @public
 */
export declare function setFilterPlot(idx: number, newProp: object, valueIndex?: number): Merge<SetFilterPlotUpdaterAction, {
...
export declare type ToggleEditorVisibilityUpdaterAction = {};
/**

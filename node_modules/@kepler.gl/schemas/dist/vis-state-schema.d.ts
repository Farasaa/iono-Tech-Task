...
export declare type MergerActionPayload<S extends {}> = {
    mergers: Merger<S>[];
    postMergerPayload: PostMergerPayload;
};
export declare type MergerMergeFunc<S extends {}> = (state: S, config: any, fromConfig: boolean, mergerActionPayload?: MergerActionPayload<S>) => S;
export declare type ReplaceParentDatasetIdsFunc<T> = (item: T, dataId: string, dataIdToReplace: string) => T | null;
export declare type Merger<S extends {}> = {
...
export declare type VisStateMergers<S extends {}> = Merger<S>[];

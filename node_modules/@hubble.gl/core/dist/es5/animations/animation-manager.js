...
var AnimationManager = function () {
  function AnimationManager(_ref) {
    var _ref$timeline = _ref.timeline,
        timeline = _ref$timeline === void 0 ? undefined : _ref$timeline,
    ...
    this.timeline = timeline || new _engine.Timeline();
  ...
  (0, _createClass2.default)(AnimationManager, [{
    key: "attachAnimation",
    value: function attachAnimation(animation) {
      animation.attachKeyframes(this.timeline);
      this.animations[animation.id] = animation;
    }
  }, {
    key: "setKeyframes",
    value: function setKeyframes(animationId, params) {
      this.animations[animationId].setKeyframes(_objectSpread({
        timeline: this.timeline
      }, params));
    }
  }, {
    key: "getKeyframes",
    value: function getKeyframes(animationId) {
      return this.animations[animationId].getKeyframes();
    }
  }, {
    key: "getAnimation",
    value: function getAnimation(animationId) {
      return this.animations[animationId];
    }
  }, {
    key: "draw",
    value: function draw() {
      Object.values(this.animations).forEach(function (animation) {

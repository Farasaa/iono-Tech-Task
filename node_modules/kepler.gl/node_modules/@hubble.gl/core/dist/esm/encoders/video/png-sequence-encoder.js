...
var PNGSequenceEncoder = function (_FrameEncoder) {
  _inherits(PNGSequenceEncoder, _FrameEncoder);
  ...
  function PNGSequenceEncoder(settings) {
    ...
    _classCallCheck(this, PNGSequenceEncoder);

    _this = _super.call(this, settings);

    _defineProperty(_assertThisInitialized(_this), "tarBuilder", void 0);

    _this.mimeType = TARBuilder.properties.mimeType;
    _this.extension = ".".concat(TARBuilder.properties.extensions[0]);
    _this.tarBuilder = null;
    return _this;
  }

  _createClass(PNGSequenceEncoder, [{
    key: "start",
    ...
    value: function () {
      var _add = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(canvas) {
        var mimeType, extension, buffer, filename;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                extension = '.png';
                _context.next = 4;
                return canvasToArrayBuffer(canvas, mimeType);

              case 4:
                buffer = _context.sent;
                filename = pad(this.tarBuilder.count) + extension;
        ...
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this.tarBuilder.build());

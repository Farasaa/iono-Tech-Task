...
export var VideoCapture = function () {
  ...
  _createClass(VideoCapture, [{
    ...
    value: function save(callback) {
      ...
      if (!callback) {
        callback = function callback(blob) {
          ...
          if (blob) {
            download(blob, _this2.filename + _this2.encoder.extension, _this2.encoder.mimeType);
          }
    ...
    key: "_capture",
    value: function () {
      var _capture2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(canvas) {

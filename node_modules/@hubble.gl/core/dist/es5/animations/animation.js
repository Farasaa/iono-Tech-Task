...
var Animation = function () {
  function Animation(_ref) {
    ...
    (0, _defineProperty2.default)(this, "unattachedKeyframes", []);
    this.id = id;
  ...
  (0, _createClass2.default)(Animation, [{
    key: "attachKeyframes",
    value: function attachKeyframes(timeline) {
      var _iterator = _createForOfIteratorHelper(this.unattachedKeyframes),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var keyframes = _step.value;
    ...
    key: "attachAnimator",
    value: function attachAnimator(animator) {

...
export declare const ActionPanelItem: React.MemoExoticComponent<({ children, color, className, Icon, label, onClick, isSelection, isActive, style }: ActionPanelItemProps) => React.JSX.Element>;

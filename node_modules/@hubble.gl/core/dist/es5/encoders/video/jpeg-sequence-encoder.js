...
var JPEGSequenceEncoder = function (_FrameEncoder) {
  (0, _inherits2.default)(JPEGSequenceEncoder, _FrameEncoder);

  var _super = _createSuper(JPEGSequenceEncoder);

  function JPEGSequenceEncoder(settings) {
    var _this;

    (0, _classCallCheck2.default)(this, JPEGSequenceEncoder);
    ...
    if (settings.jpeg) {
      _this.options = _objectSpread({}, settings.jpeg);
    }

    _this.options.quality = _this.options.quality || 1.0;
  ...
  (0, _createClass2.default)(JPEGSequenceEncoder, [{
    key: "start",
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                extension = '.jpg';
                _context.next = 4;
                return (0, _utils.canvasToArrayBuffer)(canvas, mimeType, this.options.quality);
  ...
  return JPEGSequenceEncoder;
}(_frameEncoder.default);

var _default = JPEGSequenceEncoder;

...
exports.parseSetCameraType = parseSetCameraType;
exports.msConversion = msConversion;
...
function parseSetCameraType(strCameraType, viewState) {
  ...
  var turfPoint = (0, _helpers.point)([modifiedViewState.longitude, modifiedViewState.latitude]);
  ...
  if (setChecker.has(match[0])) {
    if (match[0] === 'East') {
      var translatedPoly = (0, _transformTranslate["default"])(turfPoint, 10, 270);
      modifiedViewState.longitude = translatedPoly.geometry.coordinates[0];
    } else if (match[0] === 'South') {
      var _translatedPoly = (0, _transformTranslate["default"])(turfPoint, 10, 0);

      modifiedViewState.latitude = _translatedPoly.geometry.coordinates[1];
    } else if (match[0] === 'West') {
      var _translatedPoly2 = (0, _transformTranslate["default"])(turfPoint, 10, 90);

      modifiedViewState.longitude = _translatedPoly2.geometry.coordinates[0];
    } else if (match[0] === 'North') {
      var _translatedPoly3 = (0, _transformTranslate["default"])(turfPoint, 10, 180);

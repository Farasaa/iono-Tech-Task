...
var PhotoEncoder = function (_FrameEncoder) {
  (0, _inherits2["default"])(PhotoEncoder, _FrameEncoder);
  ...
  function PhotoEncoder(settings) {
    ...
    (0, _classCallCheck2["default"])(this, PhotoEncoder);
    _this = _super.call(this, settings);
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "blob", void 0);
    _this.blob = null;
    _this.add = _this.add.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }

  (0, _createClass2["default"])(PhotoEncoder, [{
    key: "add",
    value: function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _utils.canvasToArrayBuffer)(canvas, this.mimeType, this.quality);

...
var GIFBuilder = function () {
  ...
  function GIFBuilder(options) {
    _classCallCheck(this, GIFBuilder);
  ...
  _createClass(GIFBuilder, [{
    key: "initialize",
    value: function () {
      var _initialize = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(options) {
    ...
    key: "add",
    value: function () {
      var _add = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(file) {
    ...
    key: "build",
    value: function () {
      var _build = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
    ...
    key: "_createGIF",
    value: function () {
      var _createGIF2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4() {
        var _this = this;

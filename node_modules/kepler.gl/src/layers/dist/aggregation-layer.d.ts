import Layer, { LayerBaseConfig, LayerBaseConfigPartial, LayerColorConfig, LayerColumn, LayerSizeConfig, VisualChannelDescription, VisualChannels } from './base-layer';
...
export declare const getFilterDataFunc: (filterRange: number[][], getFilterValue: (d: any) => number[]) => (d: any) => boolean;

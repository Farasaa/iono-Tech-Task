...
import { Merge, RGBColor, VisConfigColorRange, VisConfigColorSelect, VisConfigNumber, VisConfigRange } from '@kepler.gl/types';
...
export declare const linePosAccessor: ({ lat0, lng0, lat1, lng1, alt0, alt1 }: LineLayerColumnsConfig) => (dc: DataContainerInterface) => (d: any) => any[];
...
export default class LineLayer extends ArcLayer {
    ...
    get requiredLayerColumns(): ["lat0", "lng0", "lat1", "lng1"];
    get optionalColumns(): ["alt0", "alt1"];
    get columnLabels(): {
        lat0: string;
        lng0: string;
        lat1: string;
    ...
    renderLayer(opts: any): EnhancedLineLayer[];
}
